...
//Пример 2.1 - изменения свойства обьекта
// let obj1 = { value: 10 };
...
// Пример 3 - Добавление нового свойства в обьект который ранее создан.
// const myCity  = {
//     city: "Wroclaw",
// }
// myCity.people = "Angry"
...
//Пример 4 - добавление нового свойства в обьект вариант 1
// const newObject1 = {}
// newObject1.name = "Dmitriy"; // added
// console.log(newObject1);

//Пример 4.1 - добавление нового свойства в обьект вариант 2
// const newObject1 = {}
// newObject1['name'] = "Dmitriy"; // added
// console.log(newObject1);
...
// Пример 5 - Добавляем новое значение в обьект с использованием квадратных скобок
...
//Пример 7 - перебираем все ключи (свойства) обьекта , а после значения
// const user = {
//     name: 'Dmitriy',
...
//Пример 8 - Обьеденение обьектов (Object.assign)
...
//Пример 9 - Обращение к несуществующему свойству
// const user2 = {
//     age: 20,
//     adress: {
...
//Пример 10 - использозование оператора ? (Обращение к несуществующему обьекту, но если дальше есть код то с расчетом, чтоб дальнейший код выполнился)
// const user2 = {
//     age: 20,
//     // adress: {
//     //     //city: "Wroclaw"
...
//Пример 11 - получить имена переменных с разных обьектов
// const boy ={
//     name: "Dima"
// }
// const girl = {
...
//Пример 1 - Мутирование копий, Обе переменные ссылаются на один и тот же объект в памяти и будут давать один и тот же результат.
// const myCity  = {
//     city: "Wroclaw",
//     people: 1000
// }
...
// Пример 3 - когда нужно избежать мутаций (то есть не перезаписывать значения в существующем обьекте),
// Когда мы не хотим чтобы изменения в одном обьекте влияли на другой обьект.
// И после можна вызвать два обьекта с одинаковыми свойствами но разными значениями.
// const myCity  = {
//     city: "Wroclaw",
//     people: 1000
// }
